...
public class SpellSlots {
	...
	public static class Builder {
		...
		private int eigthLevel = 0;
		private int ninthLevel = 0;
		
		public Builder(int level, String chosenClass) {
			this.level = level;
		...
		public SpellSlots Build() {
			return new SpellSlots(this);
		}
	}
	
	private SpellSlots(Builder builder) {
		firstLevel = builder.firstLevel;
		secondLevel = builder.secondLevel;
		thirdLevel = builder.thirdLevel;
		fourthLevel = builder.fourthLevel;
		fifthLevel = builder.fifthLevel;
		sixthLevel = builder.sixthLevel;
		seventhLevel = builder.seventhLevel;
		eigthLevel = builder.eigthLevel;
		ninthLevel = builder.ninthLevel;
	}
